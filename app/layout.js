export const metadata = {
  ...
  description:
    'Zoomania — Hyppopothesis. Streetwear ribelle, autentico, libero. Progettato a Venezia.',
  applicationName: 'Lagoon Rebel Wear',
  themeColor: '#111827',
  manifest: '/manifest.webmanifest',
  alternates: { canonical: 'https://www.lagoonrebelwear.com' },
  openGraph: {
    type: 'website',
    url: 'https://www.lagoonrebelwear.com',
    title: 'Lagoon Rebel Wear — Streetwear nato a Venezia',
    description:
      'Zoomania — Hyppopothesis. Streetwear ribelle, autentico, libero.',
    images: [
      {
        url: '/zoomania-hyppopothesis-hoodie-front.png',
        width: 1200,
        height: 630,
