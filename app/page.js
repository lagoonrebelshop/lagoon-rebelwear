  ...
  return (
    <>
      <main className="relative h-screen w-full overflow-hidden bg-neutral-900">
        ...
        <motion.div className="relative z-10 h-full" initial="hidden" animate="visible" variants={stagger}>
          <div className="mx-auto max-w-6xl h-full flex items-end">
            <div className="px-6 pb-20">
              <motion.p variants={fadeUp} className="text-white/70 text-[11px] md:text-xs tracking-[0.25em] mb-3">
                FALL / WINTER 2025 • VENEZIA
              </motion.p>

              <motion.h1 variants={fadeUp} className="text-white text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-3xl">
                Lagoon Rebel Wear
              </motion.h1>
      ...
      <section id="shop" className="bg-neutral-900 text-white py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="text-center">
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold">Collezione Ribelle</motion.h2>
          ...
          >
            {/* Tee */}
            <motion.div variants={cardIn} whileHover={{ y: -4 }} className="group rounded-2xl overflow-hidden bg-neutral-800/60 border border-white/10 flex flex-col">
              <div className="relative aspect-[4/5] w-full">
                <Image
                  ...
                  className="object-contain object-center transition-opacity duration-300 opacity-100 group-hover:opacity-0"
                  priority={false}
                />
                <Image
                  ...
                  priority={false}
                />
                <span className="absolute left-3 top-3 text-[11px] font-semibold tracking-wide bg-white text-black px-2 py-1 rounded-full">Zoomania</span>
              </div>
              <div className="border-t border-white/10 bg-black/60 px-4 py-3 flex flex-col gap-2">
                ...
                <AddToCartButton id="tee-lr-nero" title="Hyppopothesis — Tee" price={29} size="M" variant="Nero" className="w-full">
            ...
            <motion.div variants={cardIn} whileHover={{ y: -4 }} className="group rounded-2xl overflow-hidden bg-neutral-800/60 border border-white/10 flex flex-col">
              ...
              <div className="border-t border-white/10 bg-black/60 px-4 py-3 flex flex-col gap-2">
                ...
                <AddToCartButton id="hoodie-lr" title="Hyppopothesis — Hoodie" price={59} size="L" variant="Black" className="w-full">
                  Aggiungi al carrello
                </AddToCartButton>
              </div>
            </motion.div>
            ...
            {/* Placeholder */}
            <motion.div variants={cardIn} whileHover={{ y: -4 }} className="rounded-2xl overflow-hidden border border-white/10 bg-[#2A2A2A]">
